...
- 다음과 같이 적용 가능
<img width="200" alt="템플릿 변수" src="https://user-images.githubusercontent.com/83870423/148855048-4c86d8a3-9fd8-449a-9795-64e8cc889ae0.png">


#### 템플릿 필터
- 변수의 값을 특정 형식으로 바꿀 때 사용하며, python의 내장함수의 역할을 한다고 생각하면 됨
- 다음과 같이 적용 가능
<img width="200" alt="템플릿 필터" src="https://user-images.githubusercontent.com/83870423/148855083-001774be-c5c0-4083-a196-c77b8bbf0238.png">


#### 템플릿 태그
- html단독으로는 로직을 구성할 수 없지만 템플릿 태그를 이용하면 제어문을 통하여 로직을 구성할 수 있음
- 다음과 같이 적용 가능
<img width="300" alt="템플릿 태그" src="https://user-images.githubusercontent.com/83870423/148855097-a4a365e7-0169-4562-8b00-9a3e90020804.png">


#### 탬플릿 주석
- `{# 내용 #}`으로 템플릿 주석 이용 가능
- 다음과 같이 적용 가능
<img width="200" alt="템플릿 주석" src="https://user-images.githubusercontent.com/83870423/148855108-a4d9449d-40d6-4053-a479-7cd59eb00f42.png">
...
index.html에서는 다음과 같이 정적파일 사용을 지정해주어야 한다
<img width="400" alt="index" src="https://user-images.githubusercontent.com/83870423/148855848-9651b70c-db4d-464a-b455-4619d2a6ff66.png">
