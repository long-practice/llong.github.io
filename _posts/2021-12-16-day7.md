...
<center>$\displaystyle proj_au = \frac{u\cdot{a}}{\lVert{a}\rVert^2}a$ ($\displaystyle \frac{u\cdot{a}}{\lVert{a}\rVert^2}$는 기저 $a$의 좌표 값)</center>
...
<center>$\displaystyle m = \frac{1}{K}\sum_{i = 1}^K{x_i} \\ C =\frac{1}{K}\sum_{i = 1}^K{(x_i - m)(x_i - m)^T}$</center><br>
