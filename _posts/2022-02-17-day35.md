...
- 다음과 같이 표현 가능<br>
  $\operatorname{Proj}\left(\mathbf{t} ;\\{\mathbf{x}\_{1}, \ldots, \mathbf{x}\_{n}\\}\right)=\operatorname{argmin}\_{\mathbf{v} \in \operatorname{span}\left(\\{\mathbf{x}\_{1}, \ldots, \mathbf{x}\_{n}\\}\right)}\|\mathbf{t}-\mathbf{v}\|\_{2}$ <br>
<br>
