...
<center>$m = \frac{1}{K}\displaystyle\sum_{i = 1}^K{x_i}, C =\frac{1}{K}\displaystyle\sum_{i = 1}^K{(x_i - m)(x_i - m)^T}$</center><br>
...
<center>$C = \frac{1}{6} \begin{bmatrix} 28&18\\18&12 \end{bmatrix} \approx \begin{bmatrix} -0.84&0.55\\-0.55&-0.84 \end{bmatrix} \begin{bmatrix} 6.3&0\\0&0.555 \end{bmatrix} \begin{bmatrix} -0.84&-0.55\\0.55&-0.84 \end{bmatrix}$</center>
