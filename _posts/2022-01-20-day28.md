...
- 변수 $x, y$에 관한 이차형식은 다음과 같이 표현<br>
  $ax^2 + 2bxy +cy^2 = \begin{pmatrix}x&y\end{pmatrix}\begin{pmatrix} a & b \\
  b & c \end{pmatrix} \begin{pmatrix} x \\
  y \end{pmatrix}$<br>
<br>

- 마찬가지로 변수 $x, y, z$에 관한 이차형식은 다음과 같이 표현<br>
  $ax^2 + by^2 + cz^2 +2dxy + 2exz + 2fyz = \begin{pmatrix}x&y&z\end{pmatrix}\begin{pmatrix} a & d & e \\
  d & b & f \\
  e & f & c \end{pmatrix} \begin{pmatrix} x \\
  y \\
  z \end{pmatrix}$<br>
