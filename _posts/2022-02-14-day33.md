...
- 단일변수 $x$에 대한 가우시안 분포<br>
  $\mathcal{N}(x \mid \mu, \sigma^{2})=\displaystyle\frac{1}{(2 \pi \sigma^{2})^{1 / 2}} \exp \{-\frac{1}{2 \sigma^{2}}(x-\mu)^{2}\}$<br>
<br>
- $\boldsymbol{D}$차원 벡터 $\boldsymbol{x}$에 대한 가우시안 분포<br>
$\mathcal{N}(\mathbf{x} \mid \boldsymbol{\mu}, \Sigma)=\displaystyle\frac{1}{(2 \pi)^{D / 2}} \frac{1}{\vert\Sigma\vert^{1 / 2}} \exp \{-\frac{1}{2}(\mathbf{x}-\boldsymbol{\mu})^{T} \Sigma^{-1}(\mathbf{x}-\boldsymbol{\mu})\}$<br>
<br>
